...
export async function GET() {
  ...
  return NextResponse.json({ ok: true, counts: { patients, appointments, invoices, payments, claims, batches, attachments, sickNotes, activity, reminders, receipts, documents, attachmentBytes:storage._sum.fileSize||0 } });
}
