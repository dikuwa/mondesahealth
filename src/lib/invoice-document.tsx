...
const s = StyleSheet.create({
  ...
  invoiceNumber: { fontFamily: "Inter Tight", fontWeight: 700, color: "#18332d" },
  block: { marginTop: 20, padding: 12, backgroundColor: "#f3f6f4", flexDirection: "row", justifyContent: "space-between" },
  table: { marginTop: 20 },
  row: { flexDirection: "row", borderBottomWidth: 1, borderBottomColor: "#e4e9e6", paddingVertical: 8 },
  desc: { width: "43%" },
    ...
    <Page size="A4" style={s.page}>
      <View style={s.header}>
        ...
        <View>
          ...
          <Text style={s.invoiceMeta}><Text style={s.invoiceNumber}>{invoice.number}</Text>{"\n"}Issued {invoice.issueDate.toLocaleDateString("en-NA")}{"\n"}Status: {invoice.status}</Text>
        </View>
      </View>
