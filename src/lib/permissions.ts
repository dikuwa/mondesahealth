...
export const roleDefaults: Record<StaffRole, Permission[]> = {
  ...
  DOCTOR:["VIEW_OVERVIEW","MANAGE_APPOINTMENTS","MANAGE_PATIENTS","MANAGE_CLAIMS","VIEW_CLAIMS","EDIT_CLAIMS","VALIDATE_CLAIMS","SEARCH_ICD10","MANAGE_CONSENTS","EXPORT_CLAIM_DOCUMENTS","VIEW_ACTIVITY","VIEW_CLINICAL_INTAKE","USE_CLINICAL_AI","VIEW_SICK_NOTES","MANAGE_SICK_NOTES"],
