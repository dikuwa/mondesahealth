...
(async () => {
  ...
  const failed = !report.heroVisible || !report.mobileMenuVisible || Object.values(report.responsiveWidths).some(value => !value) || !report.bookingConfirmed || !report.duplicateSlotBlocked || !report.dashboardShowsBooking;
